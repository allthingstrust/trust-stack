...
def add_llm_provenance(text: str, model: str) -> str:
    ...
    Example:
        >>> add_llm_provenance("This is a summary.", "gpt-4o")
        "This is a summary. (Generated by gpt-4o)"
    """
...
def _llm_summarize(text: str, *, model: str = 'gpt-4o', max_words: int = 120) -> Optional[str]:
